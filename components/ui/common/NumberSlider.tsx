    ...
    return (
        <div className="p-2">
            ...
            >
                ...
                <div
                    className={`absolute top-1/2 -translate-y-1/2 -translate-x-1/2 w-4 h-4 rounded-full border-2 shadow-sm transition-[left,background-color,box-shadow] duration-200 ease-out ${
                        disabled
